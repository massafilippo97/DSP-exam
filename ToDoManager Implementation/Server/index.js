...
app.get('/api/tasks/public', taskController.getPublicTasks); //task pubblici
...
app.get('/api/users/:userId/tasks/created', passport.authenticate('jwt', { session: false }), taskController.getOwnedTasks); //tasks creati dall'utente
app.get('/api/users/:userId/tasks/assigned', passport.authenticate('jwt', { session: false }), taskController.getAssignedTasks); //tasks assegnati all'utente
app.put('/api/users/:userId/selection', passport.authenticate('jwt', { session: false }), assignmentController.selectTask);

//new routes
app.get('/api/tasks/:taskId/completion', passport.authenticate('jwt', { session: false }), taskController.getInfoCompletedTask);
app.get('/api/tasks/:taskId/users-selecting', passport.authenticate('jwt', { session: false }), taskController.getUsersSelectingTask);
app.get('/api/tasks/:taskId/completion/completion-occurrences', passport.authenticate('jwt', { session: false }), taskController.getTaskCompletionOccurrences);
