        ...
        .catch(function(response) {
            if(response == 403){
                ...
                if(response.errno === 19) {
                    utils.writeJson(res, { errors: [{ 'param': 'Server', 'msg': "The user has already completed this task." }], }, 403);
...
//ok
module.exports.getInfoCompletedTask = function getInfoCompletedTask(req, res, next) {
    Tasks.getInfoCompletedTask(req.params.taskId, req.user)
        .then(function(response) {
            utils.writeJson(res, response); 
        })
        .catch(function(response) {
...
//ok
module.exports.getUsersSelectingTask = function getUsersSelectingTask(req, res, next) {
    Tasks.getUsersSelectingTask(req.params.taskId, req.user)
        .then(function(response) {
            utils.writeJson(res, response); 
        })
        .catch(function(response) {
...
//ok
module.exports.getTaskCompletionOccurrences = function getTaskCompletionOccurrences(req, res, next) {
    Tasks.getTaskCompletionOccurrences(req.params.taskId, req.user)
        .then(function(response) {
            utils.writeJson(res, response); 
        })
        .catch(function(response) {
